        ...
        try {
            ...
            if ($password === "123") {
                ...
                if ($Salida->InsertarSalida() > 0) {
                    ...
                    ?>
                    <div class="alert alert-danger">Ocurrió un error. Inténtelo más tarde.</div>
                    <?php
                }
            } else {
                ?>
            ...
            ?>
            <div class="alert alert-danger">Ocurrió un error inesperado. Inténtelo más tarde.</div>
            <?php
        }
    }
                ...
                <tr>
                    ...
                    <td style="width:2%;">
                        <button type="button" name="btnMas" id="btnMas"
                                data-toggle="modal" data-target="#SeleccionProducto"><span
                                    class="glyphicon glyphicon-search"></span>
                        </button>
                    </td>
                    <td>
                        <input value="0" type="number" class="form-control" id="txtCantidad" name="txtCantidad"
                               min="0"/>
                    </td>
                    <td style="width:13%;">
